...
const AboutUs = () => {
    ...
    return (
        ...
        <div className="instructor-section style-4 padding-tb section-bg-ash">
                ...
                <div className="section-wrapper">
                              ...
                              <div key={i} className="count-item">
                                 <div className="count-inner">
                                  ...
                                  <div className="count-content">
                                      <h2>
                                          <span className="count"><CountUp end={vol.count} /></span>
                                          <span ></span>
                                      </h2>
                    ...
                    <div className="instructor-content">
                            <span className="subtitle">{subTitle}</span>
                                ...
                                <p>{desc}</p>
                                <Link to="/sign-up" className="lab-btn">Apply</Link>
                            </div>
                    </div>
                    <div className="col">
                        <div className="instructor-thumb">
                            <img src="/src/assets/images/instructor/01.png" width={400} height={400 } alt=""/>
                          </div>
                      </div>
                  </div>
              </div>
